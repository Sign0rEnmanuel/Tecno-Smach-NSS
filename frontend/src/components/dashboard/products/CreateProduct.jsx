...
export default function CreateProduct({ onClose, createProductMutation }) {
            ...
            <div className="product-form-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <form className="product-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-actions">
                        ...
                        <button type="submit" className="form-submit-btn" disabled={createProductMutation.isPending}>
